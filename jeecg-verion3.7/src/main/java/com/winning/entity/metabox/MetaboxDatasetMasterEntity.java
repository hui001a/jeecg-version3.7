 ...
 */
@Entity
@Table(name = "metabox_dataset_master", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class MetaboxDatasetMasterEntity implements java.io.Serializable {
	/**id*/
	 ...
	 */
	@Column(name ="DATA_REPRESENT",nullable=true,length=32)
